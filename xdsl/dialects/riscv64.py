...
@irdl_op_definition
class SlliRV64Op(SlliOp):
    name = "riscv64.slli"

    @classmethod
    def immediate_bw(cls):
        from xdsl.dialects.builtin import IntegerType, Signedness

        return IntegerType(6, Signedness.UNSIGNED)


@irdl_op_definition
class SrliRV64Op(SrliOp):
    name = "riscv64.srli"
...
@irdl_op_definition
class SraiRV64Op(RdRsImmShiftOperation):
    name = "riscv64.srai"
...
@irdl_op_definition
class RoriRV64Op(RoriOp):
    name = "riscv64.rori"
    
@irdl_op_definition
class RoriwRV64Op(RoriwOp):
    name = "riscv64.roriw"
