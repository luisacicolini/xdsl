...
class SlliRV32Op(SlliOp):
    ...
    def immediate_bw(cls):
        ...
        return IntegerType(5, Signedness.UNSIGNED)


@irdl_op_definition
class SrliRV32Op(SrliOp):
    name = "riscv32.srli"
...
@irdl_op_definition
class SraiRV32Op(RdRsImmShiftOperation):
    name = "riscv32.srai"
...
@irdl_op_definition
class RoriRV32Op(RoriOp):
    name = "riscv32.rori"
    
@irdl_op_definition
class RoriwRV32Op(RoriwOp):
    name = "riscv32.roriw"
